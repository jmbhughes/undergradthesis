...
\onehalfspacing
\chapter*{Abstract}
Instead of leaving this blank, here is an abstract for an upcoming presentation at the American Geophysical Union of the work that motivated this chapter:
...
\section{Motivation}
The Sun is ever-changing and impacts Earth in many ways every day. Earth is situated inside the Sun's tremendous magnetic field. Features on the Sun evolve and expose Earth to new environmental conditions. The interaction between the Sun's magnetic field and Earth is called space weather. Even though space weather manifests itself in many different way, it ultimately stems from the Sun. Table \ref{tab:solarfeatures} details some different types of solar features, many of which can lead to space weather events while others are indicative of a calm, quiet Sun.
...
\subsection{Space Weather Phenomenon}
